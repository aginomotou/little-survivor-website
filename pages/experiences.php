...
<head>
  ...
  <link rel="stylesheet" href="<?= $base ?>assets/css/pages/experiences.css">
</head>
...
<body>
  ...
  <section class="hero" id="hero" aria-labelledby="exp-hero-title">
    ...
    <div class="hero-content">
      ...
      <a href="#atv" class="btn-frosted">Explore Experiences</a>
    </div>
  </section>
  ...
  <div class="activity-block activity-block--light reveal" id="atv">
    ...
    <div class="activity-content">
      ...
      <div class="activity-price">
        &#8369;200 <span class="activity-price-unit">/ hour</span>
      </div>
    </div>
  </div>
